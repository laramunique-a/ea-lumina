...
export const LANDING_THEME = {
  ...
  typography: {
    ...
    titleGradient: "text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-black tracking-tight mb-2 md:mb-6 leading-snug md:leading-tight bg-clip-text text-transparent",
