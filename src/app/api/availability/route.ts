...
const slotSchema = z.object({
  ...
  date:         z.string().optional().nullable(), // ISO date string "YYYY-MM-DD"
...
const saveSchema = z.object({
  ...
  targetDate: z.string().optional().nullable(), // Se enviado, limpa apenas essa data
})
...
// POST — salva/substitui disponibilidade (Semanal ou Data Específica)
export async function POST(request: NextRequest) {
  try {
    ...
    const { targetDate, slots } = validated.data
