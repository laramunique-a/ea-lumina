      ...
      <div className="p-6 space-y-4">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex gap-3 text-sm text-blue-800 animate-in fade-in slide-in-from-top-4 duration-500">
          ...
          <div className="space-y-1">
            <p className="font-bold">Guia de Gestão:</p>
            <ul className="list-disc list-inside space-y-0.5 text-blue-700/80 text-[13px]">
              <li><span className="font-bold text-blue-800">Revogar Aprovação:</span> Oculta o perfil da busca para pacientes. O terapeuta ainda consegue logar no portal.</li>
              <li><span className="font-bold text-blue-800">Desativar:</span> Bloqueia o acesso total (login) do usuário à plataforma.</li>
            </ul>
          </div>
        </div>
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0 flex-wrap justify-end">
                    ...
                    {!therapist.therapistProfile?.approved && (
                      <Button
                        ...
                        className="bg-[#0090FF] hover:bg-[#0077EE]"
                      >
                        <CheckCircle size={14} />
                        Aprovar
                      </Button>
                    ...
                    {therapist.therapistProfile?.approved && (
                      <Button
                        ...
                        variant="outline"
                        onClick={() => {
                          if (window.confirm('Tem certeza que deseja revogar a aprovação deste terapeuta? O perfil deixará de ser exibido nos resultados de busca.')) {
                            handleApprove(therapist.id, false)
                          }
                        }}
