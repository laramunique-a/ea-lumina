    ...
    <>
      <div className="p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { label: 'Total', value: counts.total, icon: <Users size={16} />, color: 'bg-blue-50 text-[#0090FF]' },
            { label: 'Terapeutas', value: counts.terapeuta, icon: <UserCheck size={16} />, color: 'bg-amber-50 text-[#C5A03F]' },
            { label: 'Pacientes', value: counts.paciente, icon: <Users size={16} />, color: 'bg-indigo-50 text-indigo-700' },
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <select
              ...
              className="px-3 py-2 rounded-xl text-sm border border-surface-200 bg-white text-slate-600 focus:outline-none focus:ring-2 focus:ring-[#0090FF]/30"
            >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-full ${
                            user.active
                              ? 'bg-blue-50 text-[#0090FF]'
                              : 'bg-red-50 text-red-700'
                          }`}
                        >
                          <span className={`w-1.5 h-1.5 rounded-full ${user.active ? 'bg-[#0090FF]' : 'bg-red-500'}`} />
