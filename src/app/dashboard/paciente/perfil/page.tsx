          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-12 gap-4 sm:gap-6">
                ...
                <div className="sm:col-span-6">
                  <Input
                    label="Estado / Província / UF"
                    value={formData.state}
                    onChange={(e) => setFormData((p) => ({ ...p, state: e.target.value }))}
                    className="bg-slate-50 border-slate-100/50 rounded-xl"
                    placeholder="Ex: SP, California, Quebec"
                    required
                  />
                </div>
                <div className="sm:col-span-6">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-[13px] font-bold text-slate-700 mb-2">
                  Qual seu principal objetivo terapêutico hoje?
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ex: Nenhum, ou nome dos medicamentos"
              ...
              <div>
                <label className="block text-[13px] font-bold text-slate-700 mb-2">
                  Expectativas gerais do tratamento
                  <span className="text-red-500 ml-0.5">*</span>
                </label>
                <textarea
