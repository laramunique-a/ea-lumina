...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      {/* ──────────────────────────────────────────────────────────
          TELA 1: HOME (REPLICAÇÃO FIEL 1:1 DA IMAGEM DO GEMINI)
      ────────────────────────────────────────────────────────── */}
      <section
        id="home"
      ...
      >
        ...
        <header className="relative z-30 flex items-center justify-between w-full max-w-[1400px] mx-auto pt-1 px-4">
          ...
          {/* Botões de Acesso (Direita Superior) */}
        ...
        {/* ── CORPO CENTRAL (DUAS COLUNAS PERFEITAS) ── */}
        <main className="relative z-30 w-full max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 items-center my-auto px-4">
          ...
          {/* COLUNA DIREITA: BOTÕES DE OBJETIVO EXATOS DA REFERÊNCIA */}
        ...
        {/* ── CARDS INFERIORES EXATOS DA IMAGEM ── */}
        <div className="relative z-30 w-full max-w-[1400px] mx-auto pb-1 px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            
            {/* CARD 1 */}
            <div className="bg-[#050b16]/75 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex flex-col items-center text-center">
        ...
        {/* ── LINHA DE RODAPÉ EXATA DA REFERÊNCIA ── */}
