...
const updateServiceSchema = z.object({
  ...
  price: z.number().gt(0, 'O valor do serviço deve ser maior que zero').optional(),
  promoPrice: z.number().gt(0, 'O valor promocional deve ser maior que zero').optional().nullable(),
