                    ...
                    <tr key={apt.id} className="hover:bg-surface-50/50 transition-colors">
                      ...
                      <td className="px-6 py-3.5 text-xs">
                        {['CONFIRMADO', 'CONCLUIDO'].includes(apt.status) ? (
                          <span className="text-[#0090FF] font-medium">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-surface-200 shadow-card p-5">
            ...
            <div className="space-y-3">
              {[
                { label: 'Confirmados/Concluídos', count: data.totalConfirmed, color: 'bg-[#0090FF]' },
              ...
              {data.topTherapists.length === 0 ? (
                ...
                data.topTherapists.map((t, i) => (
                  <div key={t.id} className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-semibold text-[#C5A03F]">
          ...
          {/* Receita vs Volume */}
          <div className="bg-gradient-to-br from-[#0090FF] to-[#0077EE] rounded-2xl p-5 text-white">
